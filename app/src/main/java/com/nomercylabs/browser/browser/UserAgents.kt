...
object UserAgents {
    ...
    fun tenFoot(context: Context, appVersion: String): String =
        "${stripWebViewMarkers(WebSettings.getDefaultUserAgent(context))} $TV_TOKEN NoMercyBrowser/$appVersion"
    ...
    fun mobile(context: Context, appVersion: String): String =
        "${stripWebViewMarkers(WebSettings.getDefaultUserAgent(context))} NoMercyBrowser/$appVersion"
